...
def accept_issue(
    ...
    paper: dict[str, Any] = {
        ...
        "one_liner": first_sentence(note) or f"Recommended paper for enzyme AI curation: {title}.",
        "why_it_matters": note or f"Accepted from GitHub issue #{suggestion.get('issue')} for enzyme AI paper curation.",
        "curator": reviewer,
        "featured": featured,
